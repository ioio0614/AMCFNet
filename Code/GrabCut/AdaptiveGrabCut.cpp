...
int main(int argc, char** argv)
{
	...
	int numberimage;
loop1:
	cout << "input picture number:  ";
	cin >> numberimage;
	number = to_string(numberimage);
loop2:
	string filename = "..\\data\\" + number + ".jpg";
	...
	for (;;)
	{
		...
		case 'w':
			...
			sprintf_s(szname, "..\\result\\%d.jpg", numberimage);
			qImg = IplImage(Result); // cv::Mat -> IplImage
